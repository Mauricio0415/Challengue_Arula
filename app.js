...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function toggleLanguage(isSpanish) {
        ...
        infotext.innerHTML = isSpanish ? '<img class="alert" src="/asset/img/alerta.png" alt="Alerta"> Solo letras minúsculas y sin acento' : '<img class="alert" src="/asset/img/alerta.png" alt="Alert"> Only lowercase letters without accents';
    }
